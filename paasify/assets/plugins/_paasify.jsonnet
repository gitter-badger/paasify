...
local plugin = {
  ...
  global_default(vars)::
    ...
    // - No variable composition here
    {
      ...
      app_namespace: std.get(vars, 'app_namespace', default=vars._prj_namespace) , # Deprecate this ?
      app_ns: std.get(vars, 'app_namespace', default=vars._prj_namespace) ,  # Shorter alias !
      ...
      # app_restart_policy: 'unless-stopped', # Should NOT override existing value ! TOFIX and reenable
      ...
      app_db_host: 'db',
      app_db_port: '3306',
# This should be configurable, either by app_service or by app_name
      app_db_name: self.app_service,
      app_db_user: self.app_service,
      app_db_passwd: self.app_service,
