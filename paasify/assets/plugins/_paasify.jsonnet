...
local plugin = {
  ...
  global_default(vars)::
    ...
    // - No variable composition here
    {
      # Generic
      # --------------------------
      #app_name: vars._stack_name,
      app_name: std.get(vars, 'app_name', default=vars._stack_name) ,
      #app_namespace: vars._prj_namespace,
  ...
  global_assemble(vars)::
    ...
    local dir_prefix = vars._stack_path_abs + vars.paasify_sep_dir;
    {
      ...
      // # Generic networks
      app_network_name: vars.app_namespace + vars.paasify_sep_net + vars.app_name + "_default",
